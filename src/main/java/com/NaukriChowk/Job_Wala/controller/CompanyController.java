...
public class CompanyController {
    ...
    public ResponseEntity<?> createJobPost(@PathVariable Long companyId, @RequestBody JobDetailDto jobPost) {
  ...
  // Update company Details
    ...
    public ResponseEntity<?> updateCompanyDetails(@PathVariable Long companyId, @RequestBody CompanyDto companyDetails){
        try{
